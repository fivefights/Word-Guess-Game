...
$(document).ready(function() {
    ...
    var solutionBank = ["pizza", "pepperoni", "cheese", "cowabunga", "donatello", "raphael", "michaelangelo", "leonardo", "mastersplinter", "shredder", "krang", "rocksteady", "bebop", "aprilo'neil", "ninja", "turtles", "teenage", "mutant", "orokusaki", "ch'rell", "hamatoyoshi", "hamatomiwa", "aceduck", "aeon", "agathamarble", "bigmouser", "baxterstockman", "baku", "amaro", "bigfoot", "anchovies", "icecream", "peanutbutter", "blade", "slash", "ratking", "dregg", "monalisa", "tempestra", "irma", "chromedome", "leatherhead", "caseyjones", "spaceshipcomputer", "carter", "biglouie", "pizzamonster", "genghisfrog", "barneystockman", "napoleonbonafrog", "seymourgutz", "captainfilch", "tokka", "mondogecko", "dirtbag", "alphaone", "rasputinthemadfrog", "usagiyojimbo", "attilathefrog", "punkfrogs", "dirksavage", "gadgetman", "globfather", "zak", "triceratons", "drakus", "scrag", "mousers", "garsongrunge", "antrax", "mung", "ray", "dask", "wingnut", "howiehardy", "electrozapper", "grillox", "raptor", "groundchuck", "scumbag", "kerma", "krulik", "tattoo", "merlin", "merrik", "mogo-san", "obento", "overdrive", "screwloose", "captainzorax", "wallyairhead"]
